    ...
    return (
        <>
            ...
            <div className="relative flex flex-col justify-start h-full pt-12 text-center xl:pt-40 xl:pl-10 xl:text-left xl:justify-center">
                ...
                <h2 className="mb-3 text-lg font-semibold md:text-3xl md:mb-5">This is Portfolio of a web engineer</h2>
                ...
                <div className="absolute top-0 flex items-end justify-center w-full h-screen -left-12 xl:left-0 xl:justify-end">
                    <img className="xl:m-32 h-1/2 xl:h-4/6" src="/img/common/top.svg" />
                </div>
