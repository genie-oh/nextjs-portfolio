    ...
    >
      <div className="-mt-24 md:-mt-32 ">
        <div className="flex items-center justify-center mx-auto overflow-hidden bg-white border-4 border-gray-200 h-36 w-52 md:w-64 md:h-48 md:border-8 rounded-2xl">
          <img src="/img/about_me/mypic.jpg" />
        </div>
      </div>
      ...
      <div className="">
        <div className="px-2">
          ...
          <p className="mb-1 text-xl text-yellow-500 ">
            ...
            {i18nData({
              ja: (
                <>
                  ...
                  <li>
                    <span className="font-bold">英語</span>
                    は、書き読みをある程度,
              ...
              ko: (
                <>
                  <li>
                    <span className="font-bold">일본어</span>는 상급 비지니스
                    수준입니다.
                  </li>
                  <li>
                    <span className="font-bold">영어</span>는 읽고 쓰기를 어느
                    정도. 말하기 듣기는 아주 약간 가능합니다.
                  </li>
                  <li>
              ...
              en: (
                <>
                  <li>
                    <span className="font-bold">JAPANESE</span> is Better
                    Business Level.
                  </li>
                  <li>
                    <span className="font-bold">ENGLISH</span> is Some reading,
                    writing. a little bit speaking, hearing.
                  </li>
                  <li>
          ...
          <div className="flex items-center justify-start mb-2">
            ...
            <span>
              {i18nData({
                ja: (
                  <>
                    <span className="font-bold">日本、東京</span>
                    に現在住んでおります。
                  </>
                ),
                ko: (
                  <>
                    <span className="font-bold">일본, 도쿄</span>에 현재
                    거주하고 있습니다.
                  </>
                ),
                en: (
                  <>
                    <span className="font-bold">Japan, Tokyo</span>, i live in
                    now.
                  </>
                ),
              })}
          ...
          <div className="flex items-center justify-start">
            ...
            <span>
              {i18nData({
                ...
                ko: (
                  <>
                    <span className="font-bold">한국</span>이 저의 본
                    국적입니다.
                  </>
                ),
                en: (
                  <>
                    <span className="font-bold">South Korea</span>, my country
                    is.
                  </>
                ),
              })}
