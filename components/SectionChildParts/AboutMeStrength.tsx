...
const AboutMeStrength = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full pb-2 pr-5 mb-3 text-sm italic text-left text-gray-500 whitespace-pre-wrap border-b-2">
        {i18nData({
      ...
      <div>
        <div className="w-full mb-1 font-bold text-center">
