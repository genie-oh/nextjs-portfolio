    ...
    <div className="w-full -mb-10" style={{ height: "350px" }}>
      <div className="relative w-full h-full -my-5">
        ...
        <div className="absolute top-0 left-0 grid w-full h-full grid-cols-2 py-10 text-xs font-bold">
          ...
          <div className="flex items-end justify-end mr-8 text-right text-yellow-500">
            INFLUENCING
          </div>
          <div className="flex items-end justify-start ml-8 text-left text-blue-500">
            RELATIONSHIP
          </div>
        </div>
      </div>
