...
const Item: FunctionComponent<{
  ...
  const articleUrl =
    articleData.moreContentUrl_i18n &&
    i18nData(articleData.moreContentUrl_i18n);
  function openUrl() {
  ...
  return (
    ...
    >
      <div
        ...
        className={
          "w-full h-full " +
          (articleData.moreContentType === "soon" ? "opacity-50" : "")
        }
      >
        ...
        {articleData.onlySupportLanguages && (
          <LanguageSupport languages={articleData.onlySupportLanguages} />
        )}
        <div className="px-5 py-1 mb-10">
          <p className={"mb-2 text-lg font-bold"}>
            {i18nData(articleData.title_i18n)}
          </p>
          <p className="pb-5 mb-3 text-sm text-gray-500">
            {i18nData(articleData.text_i18n)}
          </p>
        </div>
          ...
          <div className="flex items-center justify-between py-3 border-t-2">
            ...
            <button
              className={
                ...
                (articleData.moreContentType === "soon"
                  ? "bg-gray-500"
                  : "bg-blue-500")
              }
            >
