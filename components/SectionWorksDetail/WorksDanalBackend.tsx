        ...
        <div className="py-10 work-body">
                ...
                {i18nData({
                    ...
                    ko: (
                        <>
                            ...
                            <p>
                                본인은 2년간, 금융서비스팀에 배속되어 신용카드, 은행 송금, 상품권, 맴버쉽 포인트카드
                                등의 서버 어플리케이션과 같은 결제 백엔드 서비스에 대해 다양한 개발 업무를
                                수행하였습니다.
                                <br />
                                또한, 미들웨어개발자로써 Java기반의, 신용카드 번호에서 종별을 식별하기 위한 BIN번호 조회
                                REST-API서비스를 개발하였습니다.
                            </p>
                        </>
                    ),
                    en: (
                        <>
                            <p>
                                ...
                                users or other companies likes e-commerce, game, contents provider, etc. and having
                                first share on the field.
                            </p>
                            <p>
                                for 2 years, i had been assigned financial service team and carried out various
                                development of payment back-end service likes server applications that credit-card, bank
                                transfer, gift card, membership point card, etc.
                                <br />
                                additionally, as middleware engineer, developed REST-API service to inquery BIN number
                                to identify what kind of credit-card from credit-card number using Java.
                            </p>
                        </>
                    ),
                })}
            ...
            <div className="mb-5">
                {i18nData({
                    ...
                    ko: (
                        <p>
                            백엔드 개발자, 시스템(요건정의) 엔지니어, 소규모의 프로젝트 리더, 미들웨어 개발자로써 역할을
                            수행하였습니다.
                        </p>
                    ),
                    en: (
                        <p>
                            in the team, i had been roled as back-end engineer, system(requirement) engineer, small
                            project leader, middleware engineer.
                        </p>
                    ),
                })}
            </div>
            ...
            <div className="mb-5">
                <p>System Engineering Skill, UML, ERD, Java(Back-end), Javascript(Rhino on Java), PHP</p>
            </div>
        </div>
    );
};
