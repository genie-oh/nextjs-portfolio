    ...
    <div className="py-10 work-body">
        ...
        {i18nData({
          ja: (
            <>
              ...
              <p>
                そして、本ソリューションは、成功的にDANALの決済サービスへ導入することができました。
              </p>
            </>
          ),
          ko: (
            <>
              <p>
                주식회사 다날에서 미들웨어 솔루션 개발자로써, 요청에 따라
                이미지와 사운드를 동적으로 생성하는 캡챠 솔루션에 대한 연구 및
                개발을 주도했습니다.
              </p>
              <p>
                해당 솔루션은 본인이 제안하고 개발한 독립형 이미지 및 사운드
                생성과 처리 엔진으로 구성됩니다. 해당 솔루션은 타사의 그래픽,
                사운드 라이브러리에 의존성 없이 동작합니다. 비트맵 및 웨이브
                파일 형식 사양에 따라 바이트레벨에서 그래픽과 사운드를
                처리하도록 솔루션이 설계되었고 만들어졌기 때문입니다.
              </p>
              <p>
                그리고 성공적으로 해당 솔루션을 다날 결제 서비스에 도입할 수
                있었습니다.
              </p>
            </>
          ),
          en: (
            <>
              <p>
                as middleware solution engineer in Danal, Inc., I had been led
                researching and development to captcha solution that generate
                images and sounds on demands.
              </p>
              <p>
                the solution consist of stand-alone image and sound generating
                and processing engine that suggested and developed by me. the
                solution NEVER has dependent on third-party graphic, sound
                library. because, the solution had been made to only process
                graphic and sounds on byte-level following Bitmap and Wave File
                Format Specifications.
              </p>
              <p>
                And successfully, the solutions can be integrated to Danal
                Payment Services.
              </p>
            </>
          ),
      ...
      <div className="mb-5">
        {i18nData({
          ...
          ko: (
            <p>
              미들웨서 솔루션 개발자, 시스템(요건정의) 엔지니어, 프로젝트 리더,
              제안자로써 역할을 수행하였습니다.
            </p>
          ),
          en: (
            <p>
              in the project, i had been roled as middleware solution engineer,
              system(requirement) engineer, project leader. proposer.
            </p>
          ),
        })}
      </div>
      ...
      <div className="mb-5">
        <p>
          System Engineering Skill, UML, ERD, PHP. Java(for some middlewares)
        </p>
      </div>
    </div>
  );
