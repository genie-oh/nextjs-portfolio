      ...
      children: i18nData({
        ja: (
          <LeftBorderList
            ...
            titleBorder={true}
            list={[
              "特許名 -ユーザー認証のためのバーチャルキーボードの生成装置と方法-",
            ]}
          />
        ),
        ko: (
        ...
        en: (
          <LeftBorderList
            ...
            titleBorder={true}
            list={[
              "title is -VIRTUAL KEYBOARD GENERATING DEVICE AND METHOD FOR USER AUTHENTICATION-",
            ]}
          />
        ),
      }),
    ...
    <div className="py-10 work-body">
      ...
      <div className="mb-5">
        {i18nData({
          ...
          ko: (
            <>
              <p>
                신용카드 결제, 개인인증 등 입력 정보에 대해 보안이 필요한
                서비스에 적용할 수 있는 다날 안심 키보드
                <span className="text-sm italic">
                  ~종단간 사용자 데이터를 안전하게 암호화하여 전송하는 가상
                  키보드~
                </span>
                의 제안 및 개발을 진행하였습니다.
                <br />
                2014년, 이 솔루션은 사용자 데이터를 보다 안전하게 전송하기 위해
                설계되었습니다. 이후, 이 솔루션의 프로토타이핑을 수행, 특허
                출원과 동시에 전체 개발을 수행할 수 있었습니다.
              </p>
            </>
          ),
          en: (
            <>
              <p>
                I carried out project of proposal and advenced development of
                integrating Danal Ansim Keyboard
                <span className="text-sm italic">
                  ~encode securely user data between end-to-end~
                </span>
                to services likes credit-card payment, personal authentication
                service that needed security about user input. <br />
                It was designed in 2014 to provide sending user data more
                safely. after that, I can carried out that prototyping this
                solution, patent it, and advenced development.
              </p>
            </>
          ),
        })}
      ...
      <div className="mb-5">
        {i18nData({
          ...
          ko: (
            <p>
              이 프로젝트에서, 저는 미들웨어 개발자, 제안자, 프로젝트 리더,
              설계자, 웹 개발자로써 역할을 수행하였습니다.
            </p>
          ),
          en: (
            <p>
              in the project, i had been roled as middleware engineer, proposer,
              project leader, architect, web engineer.
            </p>
          ),
        })}
      </div>
      ...
      <div className="mb-5">
        {i18nData({
          ja: (
            <p>
              Payment
              Gateway分野では不正アクセスに対して防ぎ、決済利用者からの入力情報を、
          ...
          ko: (
            <p>
              Payment Gateway 분야에서 불법적인 접근에 대해 방어하고, 결제
              이용자로부터 입력받는 정보를 보다 안전하게 처리하기 위한 솔루션의
              필요성이 높아졌습니다.
              <br />
              사용자의 개인식별정보 및 금융 정보를 다루는 PG 서비스 특성상,
              무엇보다 MiTM 유형 공격 및 Key Logging 등 사용자가 입력하는 정보를
              가로챌 수 있는 공격 유형에 대해 일정 수준의 높은 보안성을 기대할
              수 있는 방법이 검토되었습니다.
              <br />
              이에 상당 부분이 웹 기반 서비스로 이루어져 있는 PG 서비스에서,
              “보다 보안성이 강화된 사용자 정보 입력”에 대한 중요성에 기인하여
              웹기반 가상 키보드 설계를 제안, 아래 내용을 수행하였습니다.
            </p>
          ),
          en: (
            <p>
              in Payment Gateway fields, the needs had been important to process
              privacy information which user input more securely and prevent it
              from attacks.
              <br />
              bacause Payment Gateway needs to handle user's privacy and
              financial information, The method had been consider that can be
              expected to high-level security about privacy information which
              user input from attacks likes MiTM, Key Logging.
              <br />
              so, I have carried out proposal and design architecture of
              web-base end-point encryption virtual keyboard to satisfy the
              needs that achive more securely handling about privacy data which
              user input on Payment Gateway Service which entirely consist of
              web-base.
            </p>
          ),
        })}
      ...
      <div className="mb-5">
        <p>
          System Engineering Skill, UML, ERD, Java(Middleware), PHP(Back-end),
          Front-end.
        </p>
      </div>
    </div>
