...
const WorksOzvisionComic = () => {
            ...
            children: i18nData({
                ...
                ko: (
                    <>
                        ...
                        />
                        <p className="text-gray-500">
                            ※ 아쉽게도 해당 프로젝트들은 수행 중, 서비스 종료가 결정되어 중단되었습니다.
                        </p>
                    </>
                ),
                en: (
                    <>
                        ...
                        />
                        <p className="text-gray-500">
                            ※ unfortunately, two projects are dropped because service close is decided.
                        </p>
                    </>
                ),
            }),
    ...
    const data2 = [
        ...
        },
        {
            ccolspan: 2,
            children: i18nData({
                ja: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_comics/workflow.png" />,
                ko: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_comics/workflow.png" />,
                en: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_comics/workflow.png" />,
            }),
        },
        {
            label: "requirement/\narchitecture",
        ...
        },
        {
            ccolspan: 2,
            children: i18nData({
                ja: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_comics/statediagram.png" />,
                ko: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_comics/statediagram.png" />,
                en: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_comics/statediagram.png" />,
            }),
        },
        {
        ...
        },
        {
            ccolspan: 2,
            children: i18nData({
                ja: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_comics/sequencediagram.png" />,
                ko: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_comics/sequencediagram.png" />,
                en: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_comics/sequencediagram.png" />,
            }),
        },
    ];
        ...
        <div className="py-10 work-body">
            ...
            <div className="mb-5">
                {i18nData({
                    ...
                    ko: (
                        <>
                            <p>
                                해피타스 코믹 서비스에서, 본인은 서비스 시작부터 종료까지 전체적인 서비스와 시스템을
                                개발 했습니다.
                                <br />
                                해당 서비스는 2018년 9월에 출시되었지만, 아쉽게도 2019년 12월을 끝으로 서비스를 종료하게
                                되었습니다.
                            </p>
                            <p>
                                해당 서비스는 웹만화 플랫폼을 제공하여 유저에서 유저로 출판 및 컨텐츠 제공을 실현합니다.
                                구체적인 기능으로는 원고를 웹만화로 변환, 웹에 게재, 유저에서 유저로 판매 및 구매 기능,
                                구매한 사용자에 한정하여 컨텐츠를 제공하는 프라이빗 컨텐츠 기능, 만화에 대한 후원 기능
                                등이 있습니다.
                            </p>
                            <p>해당 서비스에서 저는 스타트업 팀의 리드 엔지니어로써 다수의 업무를 수행하였습니다.</p>
                        </>
                    ),
                    en: (
                        <>
                            <p>
                                About service of Hapitas Comic. I had been developed entire service system from start-up
                                to service closed.
                                <br />
                                The service had been started from 2018. 9, and unfortunately closed at 2019. 12.
                            </p>
                            <p>
                                The service provided web comic platform to publish and delivery from customer to
                                customer. about specific features, they are likes convert image to web comics, publish
                                it to web, sell and buy it from customer to customer, provide it as private contents
                                that only accessible users who buy it, and social tipping on comics.
                            </p>
                            <p>in the service, i had been worked as lead engineer in start-up team.</p>
                        </>
                    ),
                })}
            </div>
            ...
            <div className="mb-5">
                {i18nData({
                    ...
                    ko: (
                        <p>
                            본인은 팀에서 리드 개발자, 프로젝트 리더, 시스템(요건정의) 엔지니어, 서비스 설계자, 오프쇼어
                            개발 유닛 매니저, 미들웨어 솔루션 개발자, 백앤드, 프론트앤드, 약간의 AWS스킬을 보유한 풀스텍
                            개발자로써 업무를 수행 했습니다.
                        </p>
                    ),
                    en: (
                        <p>
                            in the team, i had been roled as lead-engineer, project leader, system(requirement)
                            engineer, service architect, offshore development unit manager, middleware solution
                            developer, and full-stack engineer having range of back-end, front-end, a little of AWS
                            skills.
                        </p>
                    ),
                })}
            ...
            <div className="mb-5">
                {i18nData({
                    ...
                    ko: (
                        <p>
                            ※ 이하 이미지는 회사의 소유이기 떄문에 상세 내용은 보이지 않도록 처리되어 있으므로 양해
                            부탁드립니다.
                        </p>
                    ),
                    en: <p>※ please notice that below images are hidden because assets is owned by company.</p>,
                })}
            </div>
            ...
            <div className="mb-5">
                <p>System Engineering Skill, UML, ERD, PHP(Webpage), PHP(Batch Processing), Mysql, Front-end, AWS</p>
            </div>
        </div>
    );
};
