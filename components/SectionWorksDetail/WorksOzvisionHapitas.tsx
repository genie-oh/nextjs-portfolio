...
const WorksOzvisionHapitas = () => {
    const data1 = [
        ...
        },
        {
            ...
            colspan: 3,
            children: i18nData({
                ja: <p className="font-bold">マーケティング組織の目標に必要な多数の開発業務を遂行.</p>,
                ko: <p className="font-bold">마케팅조직 목표에 필요한 다수의 개발 업무를 수행.</p>,
                en: <p className="font-bold">develop various middle & small features for needs of marketing goals.</p>,
            }),
        },
        {
            label: null,
        ...
        },
        {
            ...
            children: i18nData({
                ...
                ko: (
                    <p className="text-gray-500">
                        ※ 해피타스 팀에서 스타트업 서비스인 해피타스 코믹 서비스의 팀에 배속되어 별도 업무를 수행
                    </p>
                ),
                en: (
                    <p className="text-gray-500">
                        ※ left from hapitas team because assign Hapitas Comic Team which start up service.
                    </p>
                ),
            }),
        },
    ...
    const data2 = [
        ...
        },
        {
            ccolspan: 2,
            children: i18nData({
                ja: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_hapitas/milestone.png" />,
                ko: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_hapitas/milestone.png" />,
                en: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_hapitas/milestone.png" />,
            }),
        },
        {
            label: "Requirement\nDefinition",
        ...
        },
        {
            ccolspan: 2,
            children: i18nData({
                ja: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_hapitas/workflow.png" />,
                ko: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_hapitas/workflow.png" />,
                en: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_hapitas/workflow.png" />,
            }),
        },
        {
            label: "System\nDesign",
        ...
        },
        {
            ccolspan: 2,
            children: i18nData({
                ja: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_hapitas/diagram.png" />,
                ko: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_hapitas/diagram.png" />,
                en: <img className="w-32 lg:w-80" src="/img/works/works_ozvision_hapitas/diagram.png" />,
            }),
        },
    ];
        ...
        <div className="py-10 work-body">
            ...
            <div className="mb-5">
                {i18nData({
                    ...
                    ko: (
                        <>
                            <p>
                                저는 2017년부터 해피타스라는 어필리에이트로 포인트 적립을 제공하는 서비스에서 여러
                                기능을 개발해 왔습니다. 이 서비스는 300만 명이 넘는 사용자를 보유하고 있으며, 다수의
                                사용자와 함께 장기적인 서비스 운영에서 쌓은 귀중한 데이터, 그리고 어필리에이트 비즈니스
                                모델에 대한 노하우를 보유하고 있습니다.
                            </p>
                            <p>
                                이 서비스에서, 저는 마케팅 조직 목표를 달성하기 위한 엔지니어 팀의 일원으로 다수 업무를
                                수행하였습니다.
                            </p>
                        </>
                    ),
                    en: (
                        <>
                            <p>
                                I had been developed several features on Hapitas Service that provide point-income by
                                affliate since 2017. this service has over 3 million users, valuable data from many
                                users and doing service long-term, and know-how which are affliate business model.
                            </p>
                            <p>in the service, i had been worked as one of engineer team to achive marketing goals.</p>
                        </>
                    ),
                })}
            </div>
            ...
            <div className="mb-5">
                {i18nData({
                    ...
                    ko: (
                        <p>
                            팀에서 저는 팀 서브리더, 프로젝트 리더, 시스템(요건정의) 엔지니어, 기술 어드바이저 및
                            트레이너, 미들웨어 솔루션 개발 및 백앤드, 프론트엔드, 일부의 AWS스킬을 보유한 풀스택
                            엔지니어로써의 역할을 수행하였습니다.
                        </p>
                    ),
                    en: (
                        <p>
                            in the team, i had been roled as team sub-leader, project leader, system(requirement)
                            engineer, tech advisor/trainer, middleware solution developer, and full-stack engineer
                            having range of back-end, front-end, a little of AWS skills.
                        </p>
                    ),
                })}
            </div>
