  ...
  return (
    <div className="py-10 work-body">
        ...
        {i18nData({
          ja: (
            <>
              ...
              <p>
                本プログラムは、CISCOルーターが提供するUDP基盤のNetFlow
                Protocolを利用し、
          ...
          ko: (
            <>
              ...
              <p>
                이 프로그램은 시스코 라우터에서 제공하는 UDP기반 NetFlow
                Protocol을 이용하여 시스코 라우터의 트래픽을 분석하는
                프로그램입니다. 이 프로그램은 C#과 안드로이드로 개발되었습니다.
              </p>
              <p>
                이 프로그램에서는 네트워크 인터페이스에 대한 특정 트래픽과
                소스IP, 도착지IP, 포트, 프로토콜 등의 정보를 모니터링 할 수
                있습니다.
              </p>
              <p>
          ...
          en: (
            <>
              ...
              <p>
                this is program to analyze traffics through out on cisco router
                using NetFlow Protocol provided by CISCO router based UDP. And,
                the program had been developed by C# and Android App.
              </p>
              <p>
                the program enable you to mornitoring specific traffic for
                network interfaces and informations of source ip, destination
      ...
      <div className="mb-5">
        {i18nData({
          ja: (
            <p>全ての機能においての開発やプロジェクト進行をリードしました。</p>
          ),
      ...
      <div>
        {i18nData({
          ...
          ko: (
            <>
              <p>
                NetFlow는 시스코 라우터의 트래픽 분석 기능입니다. 시스코의
                라우터는 시장에서 70%이상의 점유율로 널리 사용되고 있습니다. 이
                기능을 사용하면 타 제품과 비교하여 보다 구체적으로 트래픽
                모니터링을 수행할 수 있습니다.
              </p>
              <p>
                하지만 해당 데이터는 라우터의 캐시 메모리에 RAW데이터로써
                저장되기 떄문에 원 상태에서의 분석은 어렵습니다. 따라서 보다
                쉽게 분석할 수 있도록 라우터는 주기적으로 트래픽 정보를 NetFlow
                Colector로 전송합니다.
              </p>
              <p>
                이 프로그램은 시스코 라우터에서 전송된 데이터를 수집 및 분석하여
                생성된 정보를 보여줍니다.
              </p>
            </>
          ),
          en: (
            <>
              <p>
                Netflow is feature of analysis traffic of cisco router. Cisco's
                router is used widly having shares of 70% on the field. the
                feature enable you to monitoring more specific compare with
                others.
              </p>
              <p>
                But, it is hard to analysis data because stored as rawdata on
                cache memory in router. so, for you to analysis more easily,
                router transfer traffic information to NetFlow Colector
                periodically.
              </p>
              <p>
                The Program is that for you to see informations which is made by
                collecting and analyzing the data transferred by Cisco Router.
              </p>
            </>
          ),
        })}
      ...
      <div className="relative mb-14">
        ...
        <div className="absolute bottom-0 w-full py-0.5 text-sm text-center text-white bg-black bg-opacity-70">
          ※ network environment examples and analysis traffic of the
          environment.
        </div>
      </div>
