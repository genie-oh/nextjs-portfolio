      ...
      <div className="mb-5">
        {i18nData({
          ...
          ko: (
            <>
              <p>
                2010년 대학 CCNP과정에서 프로젝트 리더로서 수행한
                팀프로젝트입니다.
              </p>
              <p>
                다양한 네트워크 환경을 구축하면서 어떻게 작동하고 개선할지
                분석하고 연구합니다. 환경은 IGP(중소 네트워크 라우팅을 위한 RIP,
                EIGRP, OSFP등), BGP(타 AS시스템 간 내부 네트워크 정보를 교환하는
                게이트웨이 프로토콜), BGP 간 링크 프레임 릴레이, 멀티 홉 IBGP,
                복수 라우팅 프로토콜 간 재분배, DHCP, VIRTUAL-LINK, IPv6터널링
                등 다양한 기술을 사용하였습니다.
              </p>
              <p>
                마지막으로 이 프로젝트의 목적은 네트워크 토폴로지 설계 기술과
                실제 네트워크 환경이 만들어지는 방법을 배우고 습득하는 것에
                있습니다.
              </p>
            </>
          ),
          en: (
            <>
              <p>
                this is team project on CCNP course at 2010 carrying out it as
                project leader.
              </p>
              <p>
                study analysis how to works and how to improvement it as making
                varous network environments. the environments are likes
                IGP(likes RIP, EIGRP, OSFP for small and middle network
                routing), BGP(Gateway Protocol for notify inter-network to other
                AS System), link Frame-Relay between BGP, multi-hop IBGP,
                re-distribute between various routing protocols, DHCP, Virtual
                Link, IPv6 tunneling.
              </p>
              <p>
                finally, this project's aim to learn and recognize skills of
                network topology design and how real network environment is
                made.
              </p>
            </>
          ),
