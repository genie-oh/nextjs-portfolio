                ...
                {i18nData({
                    ...
                    ko: (
                        <>
                            ...
                            <p>
                                먼저 Dynamips 시스코 라우터 에뮬레이터와 VMWare 호스트 에뮬레이터를 사용하여
                                OSI7계층에서 2계층 네트워크 환경을 구축합니다.
                            </p>
                            <p>
                                이 환경은 클라이언트와 공격자로 구성됩니다. 공격자는 다양한 공격 도구를 제공하는
                                리눅스인 BackTrace를 사용하여 공격을 수행합니다. 그 공격과정에서 패킷 캡쳐를 통해 현상을
                                분석합니다.
                            </p>
                            <p>
                                마지막으로 원 데이터와 비교해 패킷이 어떻게 바뀌는지, 어떠한 피해 현상이 발생하는지
                                분석하고 공격을 방지하는 방법을 연구합니다.
                            </p>
                        </>
                    ),
                    en: (
                        <>
                            <p>this is project to thesis for graduating university at 2011.</p>
                            <p>
                                at first, make the environment consist of 2 Layer of OSI7 layers features using Dynamips
                                Cisco Router Emulator and Vmware Host Emulator.
                            </p>
                            <p>
                                the environment consists of Client and Attacker. the attacker attacks using BackTrace
                                which is linux providing various attack tools. and check the results by packet dump
                                tool.
                            </p>
                            <p>
                                finally, analyze how the packet is changed with original, and study how to prevent the
                                attacks.
                            </p>
                        </>
                    ),
