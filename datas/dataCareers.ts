...
export const dataCarrers: I_struct[] = [
    ...
    },
    {
        ...
        categories: ["Patent Project Leader", "Middleware Solution Engineer", "Software Architect", "Web Engineer"],
        where: "DANAL, Inc.",
        whereUrl: "https://www.danalpay.com",
        country: "korea",
        textlist_i18n: [
    ...
    },
    {
        ...
        categories: ["programming", "data structure", "os", "network", "digital engineering"],
