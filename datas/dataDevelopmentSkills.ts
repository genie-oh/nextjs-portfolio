...
export const dataDevelopmentSkills: I_Skills[] = [
    {
        ...
        text_i18n: {
            ja: "PHPの深い理解を持ち、Laravel, Symfony, Codeigniterなど、多様なフレームワークでのの開発経験があります。",
            ko: "PHP에대한 깊은 이해와 함께, Laravel, Symfony, Codeigniter등의 다양한 프레임워크로의 개발 경험이 있습니다.",
            en: "Having deepened as skill about PHP core and some framework which are Laravel, Symfony, Codeigniter, etc. Additionally, I have wide experience about developing services using it.",
        },
        iconComponent: SiPhp,
    },
    {
    ...
    },
    {
        percent: 70,
        title_i18n: {
            ja: "JavaScript, TypeScript",
            ko: "JavaScript, TypeScript",
            en: "JavaScript, TypeScript",
        },
        text_i18n: {
            ja: "ECMA6, ECMA5の詳細仕様とコアメカニズムに対する一部知識を含め、JavaScriptとTypeScript言語の知識を持っております。",
            ko: "ECMA6, ECMA5 상세 사양과 핵심 메커니즘에 대한 일부 지식과 함께 JavaScript와 TypeScript언어의 지식을 보유하고 있습니다.",
            en: "Having knowledge about JavaScript and TypeScript with some ECMA6 and ECMA5 specification and core mechanism.",
        },
